...
from motion_service import go2rtc_stream_name

def test_go2rtc_stream_name():
    """Test generating go2rtc stream name."""
    assert go2rtc_stream_name(1) == "cam_1"
    assert go2rtc_stream_name("front_door") == "cam_front_door"

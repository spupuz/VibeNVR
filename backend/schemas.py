...
class CameraBase(BaseModel):
    ...
    snapshot_storage_profile_id: Optional[int] = None
    archive_storage_profile_id: Optional[int] = None
    ...
    max_movie_length: Optional[int] = 300  # Default 5 minutes, recommended range 60-900

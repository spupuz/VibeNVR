        ...
        try {
            ...
            if (res.ok) {
                ...
                setGlobalSettings(prev => ({
                    ...
                    oauth_auto_redirect: data.oauth_auto_redirect?.value !== undefined ? String(data.oauth_auto_redirect.value).toLowerCase() === 'true' : prev.oauth_auto_redirect,
        ...
        try {
            await fetch('/api/settings/bulk', {
                ...
                body: JSON.stringify({
                    ...
                    oauth_auto_redirect: Boolean(settingsToSave.oauth_auto_redirect).toString(),

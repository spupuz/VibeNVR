...
- **Localization (i18n)**: All UI strings are decoupled from JSX using `react-i18next`. Translation dictionaries for 10 supported languages are auto-generated via Python scripts (`frontend/scripts/update_locales.py` and `auto_translate.py`).
